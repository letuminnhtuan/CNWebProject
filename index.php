...
<section class="home" id="home">
    ...
    <h3 data-speed="-2" class="home-parallax">find your phone</h3>

    <img data-speed="5" class="home-parallax" src="image/banner.jpg" alt=""
    style="width=100px">

    <a data-speed="7" href="#" class="btn home-parallax">explore phones</a>
